...
export type Product = { id:string; model:string; category:string; name:Translated; description:Translated; instrumentType?:string; applications?:string[]; datasheetUrl?:string; };
