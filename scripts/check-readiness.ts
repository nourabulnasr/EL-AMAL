...
console.log(JSON.stringify({customerVerificationDeliveryEnabled:process.env.VERIFICATION_DELIVERY_ENABLED==='true',verificationEncryptionConfigured:(process.env.PAYLOAD_SECRET?.length??0)>=32}));
